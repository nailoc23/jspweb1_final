		    ...
		    <div class="col-lg-6">
		      ...
		      <form action="withdrawpro.jsp" method="post" role="form" class="php-email-form">
		        ...
		        <div class="text-center mt-4">
		          <button type="submit" class="btn btn-primary" id="withdraw">탈퇴하기</button>
		          <button type="button" class="btn btn-primary" id="logout" onclick="location.href='loginform.jsp'">로그아웃</button>
		        </div>
		      </form>
		    </div>
		  </div>
